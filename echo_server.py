...
# 소켓을 지정한 HOST와 PORT에 결합
server_socket.bind((HOST, PORT))
# 클라이언트의 연결 요청을 받을 준비 (리스닝 시작)
server_socket.listen()

print(f"Echo 서버 시작 : {HOST}:{PORT}에서 클라이언트 연결 대기 중...")

# 클라이언트가 연결을 시도할 때까지 대기
